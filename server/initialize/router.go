...
func Routers() *gin.Engine {
	...
	Router.LoadHTMLGlob("home/view/page/*")
	...
	{
		homeRouter.InitIndexRouter(HomeGroup)
		homeRouter.InitAboutRouter(HomeGroup)
		homeRouter.InitBlogRouter(HomeGroup)
		homeRouter.InitContactRouter(HomeGroup)
		homeRouter.InitCommentRouter(HomeGroup)
	}
